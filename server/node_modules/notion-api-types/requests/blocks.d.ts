...
export interface LinkToPage extends BlockBase {
    type?: 'link_to_page';
    link_to_page: PartialPick<NotionResponse.Blocks.LinkToPage['link_to_page'], 'type'>;
}
export interface Table extends BlockBase {
    type?: 'table';
    table: PartialPick<NotionResponse.Blocks.Table['table'], 'has_column_header' | 'has_row_header'> & {
        children: TableRow[];
    };
}

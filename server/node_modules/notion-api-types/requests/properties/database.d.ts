...
export interface Relation extends DatabasePropertyBase {
    type?: 'relation';
    relation: Pick<NotionResponse.DatabaseProperties.Relation['relation'], 'database_id'>;
}
declare type ResponseRollup = NotionResponse.DatabaseProperties.Rollup['rollup'];
export interface Rollup extends DatabasePropertyBase {
    type?: 'rollup';
    rollup: PartialPick<ResponseRollup, Exclude<keyof ResponseRollup, 'function'>>;
}

...
export declare type Response = Exclude<PropertyItem, {
    type: ComplexResponseTypes | 'rollup';
}> | PaginatedPropertyValues<Extract<PropertyItem, {
    type: ComplexResponseTypes;
}>> | PaginatedPropertyValues<NotionResponse.PageProperties.Relation>;
declare type ComplexResponseTypes = 'title' | 'rich_text' | 'relation' | 'people';
declare type PropertyItem = NotionResponse.PageProperty & {
    object: 'property_item';
};
declare type PaginatedPropertyValues<T extends {
    type: string;
}> = {
